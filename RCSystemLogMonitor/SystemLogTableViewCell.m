...
NSString *const kSystemLogTableViewCellIdentifier = @"kSystemLogTableViewCellIdentifier";

@interface SystemLogTableViewCell()
...
@implementation SystemLogTableViewCell
...
- (void)setLogMessage:(SystemLogMessage *)logMessage
{
...
+ (NSAttributedString *)attributedTextForLogMessage:(SystemLogMessage *)logMessage highlightedText:(NSString *)highlightedText
{
